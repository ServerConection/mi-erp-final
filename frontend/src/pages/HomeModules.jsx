...
const CATEGORIES = {
  ...
  botsIa:     { label: "Bots e IA", accent: "morado" },
...
export default function HomeModules() {
  ...
  const modules = useMemo(() => [
    ...
    { title: "BotAuditor", path: "/bot-auditor", icon: ShieldCheck, accent: "rosa", cat: "botsIa",
    ...
    { title: "Contactabilidad", path: "/bot-auditor/contactabilidad", icon: PhoneCall, accent: "azul", cat: "botsIa",
      desc: "Mensajes de cliente y asesor, tiempos de respuesta, pendientes, orígenes y etapas.",
      rolesPermitidos: ['CONSULTOR', 'SUPERVISOR', 'ANALISTA', 'GERENCIA', 'ADMINISTRADOR', 'COORDINADOR'] },
    { title: "NEXO IA", path: "/nexo-ia", icon: MessageCircle, accent: "verde", cat: "botsIa",

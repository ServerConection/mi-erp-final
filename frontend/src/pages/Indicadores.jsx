import { ORIGENES_INICIALES_NOVONET } from '../utils/origenesNovonet';
    ...
    <div className="min-h-screen bg-slate-100 p-6 font-['Inter',_sans-serif] text-slate-900">
      ...
      {tabActiva === "GENERAL" ? (
        <div className="animate-in fade-in duration-500">
          {/* Panel de filtros */}
          <div className="relative z-30 bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm mb-8 overflow-visible border border-slate-200/80" style={{boxShadow:'0 1px 3px rgba(0,0,0,.06),0 4px 16px rgba(37,99,235,.04)'}}>
            <div className="p-6 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-9 gap-4 items-end">
              ...
              <div className="flex flex-col gap-2">
                ...
                <MultiSelectCanal
                  ...
                  options={[...new Set([
                    ...ORIGENES_INICIALES_NOVONET,
                    ...(data.canales || []),
                    ...(data.origenes || []).map(o => o.trim().replace(/\s+/g, ' ')),
                  ])]}
                  accentColor="blue"
                />
              </div>
  ...
  return (
    <div className="animate-in slide-in-from-right-5 duration-500 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <ExpandableChart title="PLANES POR CATEGORÍA — NOVONET" className="bg-white p-6 rounded-2xl border border-slate-200 shadow-md" modalHeight={620}>
          <h3 className="text-[10px] font-black text-violet-600 mb-4 italic tracking-widest flex items-center gap-2 uppercase">
            <span className="w-2 h-2 bg-violet-500 rounded-full animate-pulse"></span>
            PLANES POR CATEGORÍA — INGRESADOS / ACTIVOS
          </h3>

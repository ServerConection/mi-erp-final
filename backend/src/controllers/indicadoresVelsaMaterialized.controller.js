...
const ETAPAS_GESTIONABLES = `(
    ...
    'CLIENTE CON ACUERDO','OPORTUNIDADES SUPERVISOR','PENDIENTE CIERRE','POSTVENTA NOVONET','DESCARTE','Contacto Nuevo',
    'GESTION DIARIA Pendiente Cierre','GESTION DIARIA PENDIENTE CIERRE','DOCUMENTOS PENDIENTES',
    'OPORTUNIDADES SUPERVISOR MES ACTUAL','OPORTUNIDADES SUPERVISOR MES ANTERIOR','REMARKETING',
    'ATC','FUERA DE COBERTURA','ZONA PELIGROSA','GESTION DIARIA / PENDIENTE CIERRE','OPORTUNIDADES SIUPERVISOR'
)`;

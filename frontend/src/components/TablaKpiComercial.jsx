...
const COLUMNAS = [
  ...
  { grupo: 'JOT / Leads Tot.', campo: 'pct_efect_vs_leads',   meta: 'meta_pct_efect_leads',   tipo: 'pct' },
  { grupo: 'Efectividad',   campo: 'pct_efect_vs_gestion', meta: 'meta_pct_efect_gestion', tipo: 'pct' },

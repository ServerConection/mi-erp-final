...
async function ciclo(){
  ...
  running=true;
  try{
    // NEXO IA es manual: aqui solo se procesan trabajos creados mediante el
    // boton "Generar respuesta/seguimiento".
    await service.cancelarAtascados();
    await service.cancelarPendientesAutomaticos();
...
// El worker procesa exclusivamente los borradores pedidos con el boton:

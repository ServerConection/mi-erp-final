      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-5 mb-6 shadow-sm">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 items-end">
          ...
          <div className="lg:col-span-2 flex flex-col gap-2">
            ...
            <div className="flex bg-white border border-purple-300 rounded-xl p-1.5 shadow-inner">
              <input type="date" className="bg-transparent text-slate-800 text-center text-[11px] font-bold outline-none w-full"
                value={filtros.fechaActivacionDesde} onChange={(e) => handleFiltroChange("fechaActivacionDesde", e.target.value)} />
              <span className="text-slate-300 px-1 self-center font-black">–</span>
              <input type="date" className="bg-transparent text-slate-800 text-center text-[11px] font-bold outline-none w-full"
                value={filtros.fechaActivacionHasta} onChange={(e) => handleFiltroChange("fechaActivacionHasta", e.target.value)} />
